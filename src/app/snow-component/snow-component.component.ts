...
@Component({
  selector: 'app-snow-component',
  templateUrl: './snow-component.component.html',
  styleUrls: ['./snow-component.component.css']
})
export class SnowComponentComponent implements OnInit {
